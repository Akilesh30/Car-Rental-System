...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(user_id,userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES($id,:useremail,:vhid,:fromdate,:hours,:status)";
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form action="book.php?vhid=<?php echo $vhid;  ?>" method="post">
            <div class="form-group">
              <input type="date" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
              <input type="number" class="form-control" name="hours" placeholder="no of hours" required>
            </div>
            <!---<div class="form-group">
