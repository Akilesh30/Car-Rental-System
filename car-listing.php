  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Car Listing</h1>
        <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="car-listing.php"> Carlisting</a></p>
      </div>
        ...
        ?>
            ...
            <?php while ($r = $q->fetch()): ?>
                <tr>
                  ...
                  <li >
                <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($r['VehicleId']);?>" ><img src="admin/img/vehicleimages/<?php echo htmlentities($r['Vimage1']);?>" alt="image" ></a> </div>
